			...
			<div class="join">
				...
				<form class="form-horizontal" id="myform">
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<input type="text" name="addr2" id="addr2" class="form-control" placeholder="2016년9월13일15시30분" disabled>
						</div>
					</div>
					<div class="form-group">
						<label for="addr2" class="col-md-2">수령여부</label>
						<div class="col-md-10">
							<input type="text" name="addr2" id="addr2" class="form-control" placeholder="수령 완료"
								disabled>
						</div>
					</div>
					<div class="form-group">
						<div class="col-md-15">
							<!-- 들여쓰기 -->
							<button class="btn btn-primary" ><a href="2Admin_payment.jsp">확인</a></button>
