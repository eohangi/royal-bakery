...
<body>
	...
	<div class="clientjoin">
		...
		<form class="form-horizontal" id="myform">
			...
			<div class="form-group">
				<label for="user_pw_re" class="col-md-offset-1 col-md-2">비밀번호 확인*</label>
				<div class="col-md-9">
			...
			<div class="form-group">
				<label for=uaddr2 " class="col-md-offset-1 col-md-2">질문</label>
				<fieldset>
					<div>
						<!-- 드롭다운 (싱글타입) -->
			...
			<div class="form-group">
				<label for="addr2" class="col-md-offset-1 col-md-2">답변</label>
				<div class="col-md-9">
					<input type="text" name="addr2" id="addr2" class="form-control">
				</div>
			</div>
