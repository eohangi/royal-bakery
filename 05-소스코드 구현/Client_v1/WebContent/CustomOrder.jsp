		...
		<div id="content" style="padding-top: 0px; margin-bottom: 100px;" >
			...
			<div class="clearfix">
				<div class="box2   pull-left" style="display: block;">
					...
					<textarea name="comment" id="comment" placeholder="원하시는 문구를 입력해주세요"></textarea>

					

					<input style="display:block; " type="button" class="btn btn-primary col-md-offset-5" value="구매하기"
