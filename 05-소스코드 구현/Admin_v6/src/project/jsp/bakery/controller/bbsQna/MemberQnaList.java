...
@WebServlet("/bbs/member_qna_list.do")
public class MemberQnaList extends BaseController {
	private static final long serialVersionUID = -4216338420000216266L;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) 
		...
		logger.debug("JSP에서 날라온 멤버아이디>>>>>>>>>>>>>>>>>>>>>>" + Member_id);
		
		Document document = new Document();
		document.setMemberId(Member_id);
