...
<div class="clearfix">
	<!-- 검색 폼  -->
 	<div class="pull-left">
		<form method="get" action="${pageContext.request.contextPath}/bbs/notice_list.do" style="width: 200px">
	...
	<!-- 글 쓰기 버튼 -->
	 <div class="pull-right">
		<a href="${pageContext.request.contextPath}/bbs/notice_write.do" class="btn btn-primary">
...
<nav class="text-center">
	...
	<c:choose>
		<c:when test="${pagaHelper.prevPage > 0}">
			...
			<c:url var="prevUrl" value="/bbs/notice_list.do">
