...
CREATE TABLE `product` (
  ...
  `pro_classify` char(1) NOT NULL COMMENT '빵/케익/쿠키',
  `pro_name` varchar(225) NOT NULL COMMENT '제품이름',
  `pro_price` int(11) NOT NULL COMMENT '가격',
  `stock` int(11) NOT NULL COMMENT '재고 수량',
  `status` char(1) NOT NULL COMMENT '판매여부',
  `content` text COMMENT '제품 상세설명',
  `kcal` int(11) DEFAULT NULL COMMENT '칼로리',
  `na` int(11) DEFAULT NULL COMMENT '나트륨',
  `sugar` int(11) DEFAULT NULL COMMENT '당',
  `fat` int(11) DEFAULT NULL COMMENT '지방',
  `protein` int(11) DEFAULT NULL COMMENT '단백질',
  `pro_img` varchar(255) DEFAULT NULL COMMENT '이미지경로\n',
