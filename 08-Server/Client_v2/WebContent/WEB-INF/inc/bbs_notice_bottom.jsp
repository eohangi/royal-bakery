...
<%-- 	<div class="pull-left">
	...
	<%-- <div class="pull-right">
		<a href="${pageContext.request.contextPath}/bbs.notice/document_write.do" class="btn btn-primary">
...
<nav class="text-center">
	...
	<c:choose>
		<c:when test="${pagaHelper.prevPage > 0}">
			...
			<c:url var="prevUrl" value="/bbs.notice/document_list.do">
	...
	<c:forEach var="i" begin="${pageHelper.startPage}" end="${pageHelper.endPage}" step="1">
		...
		<c:url var="pageUrl" value="/bbs.notice/document_list.do">
				<c:param name="keyword" value="${keyword}"></c:param>
	...
	<c:choose>
		<c:when test="${pagaHelper.prevPage > 0}">
			...
			<c:url var="nextUrl" value="/bbs.notice/document_list.do">
				<c:param name="keyword" value="${keyword}"></c:param>
				<c:param name="page" value="${pageHelper.nextPage}"></c:param>				
			</c:url>
			
			<li><a href="${nextUrl}">&laquo;</a></li>
		</c:when>
