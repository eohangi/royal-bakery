...
@WebServlet("/bbs.notice/document_edit_ok.do")
public class NoticeEditOk extends BaseController {
	private static final long serialVersionUID = 7428532764812957489L;
	/** 사용하고자 하는 핼퍼 객체 선언 */
	Logger logger;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) 
		...
		String url = "%s/bbs.notice/document_read.do?document_id=%d";
