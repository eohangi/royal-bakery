		...
		<div class="row">
			...
			<div class="header">
				...
				<div class="search col-md-offset-10">
					<form action="${pageContext.request.contextPath}/Payment.do"
							...
							<c:when test="${fn:length(reservationList)>0}">
								<c:forEach var="reservation" items="${reservationList}">
									<tr>
										...
										<td><c:url var="reservationUrl" value="/PaymentDetail.do">
				...
				<ul class="pagination">
					...
					<c:choose>
						<c:when test="${pageHelper.prevPage > 0}">
							...
							<c:url var="prevUrl" value="/Payment.do">
					...
					<c:forEach var="i" begin="${pageHelper.startPage}"
						...
						<c:url var="pageUrl" value="/Payment.do">
							<c:param name="orderCategory" value="${orderCategory}"></c:param>
							<c:param name="keyword" value="${keyword}"></c:param>
					...
					<c:choose>
						<c:when test="${pageHelper.nextPage > 0}">
							...
							<c:url var="nextUrl" value="/Payment.do">
								<c:param name="orderCategory" value="${orderCategory}"></c:param>
								<c:param name="keyword" value="${keyword}"></c:param>
